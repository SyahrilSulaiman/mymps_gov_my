...
function Pay() {
    ...
    useEffect(() => {
        ...
        var urlAPI = 'https://mymps.mps.gov.my/int/api_generator.php?api_name=searchBill';
    ...
    const handleBayar = () => {
        ...
        if(amount == 0.00 || amount == "") {
            ...
            var urlAPI1 = 'https://mymps.mps.gov.my/int/api_generator.php?api_name=register_payment';
